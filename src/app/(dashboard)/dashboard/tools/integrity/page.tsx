...
export default function StandaloneIntegrityPage() {
  ...
  useEffect(() => {
    if (!loading && journals.length === 1) {
      router.push(`/dashboard/journals/${journals[0].slug}/integrity`);
    }
  }, [loading, journals, router]);

  const handleGo = () => {
    if (selectedSlug) {
      router.push(`/dashboard/journals/${selectedSlug}/integrity`);
    }
  };
    ...
    <div className="max-w-xl mx-auto py-8">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Screen manuscripts for tortured phrases, validate references, and verify
          ...
          {loading ? (
            ...
            <div className="text-center py-6 space-y-3">
              ...
              <p className="text-sm text-gray-600">
                You don&apos;t have any journals yet. Create one to start integrity checks.
              </p>
