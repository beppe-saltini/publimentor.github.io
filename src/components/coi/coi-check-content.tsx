...
export interface CoiCheckContentProps {
  journalSlug?: string;
  publisherId?: string;
}

export function CoiCheckContent({ journalSlug: journalSlugProp, publisherId }: CoiCheckContentProps) {
  const params = useParams();
  const searchParams = useSearchParams();
  const slug = journalSlugProp ?? (params?.slug as string) ?? "";
