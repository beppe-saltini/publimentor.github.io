...
export interface ManuscriptsPageContentProps {
  /** Filter list to a journal (editor workspace) */
  journalId?: string | null;
  /** Pre-resolved publisher for uploads / manual create */
  publisherId?: string | null;
  /** Manuscript detail route */
  getDetailHref?: (id: string) => string;
  /** When false, only render tabs (editor shell provides title) */
...
export function ManuscriptsPageContent({
  ...
  getDetailHref = (id) => `/dashboard/manuscripts/${id}`,
  showPageHeader = true,
}: ManuscriptsPageContentProps) {
              ...
              {manuscripts.map((manuscript) => (
                <Card
                  ...
                  onClick={() => {
                    ...
                    router.push(getDetailHref(manuscript.id));
                  }}
                >
